                                            ...
                                            <div class="panel-body p-20">
                                                ...
                                                <table class="table table-hover table-bordered" border="1" width="100%">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        $cnt = 1;
                                                        $units = [1, 2, 3, 2, 3, 4, 3, 5, 1, 2, 3, 2, 3, 4, 3, 5];
                                                        $its = 0;
                                                            ...
                                                            foreach ($results as $result) {
                                                                ...
                                                                ?>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td style="text-align: center">
                                                                            <?php echo htmlentities($units[$its]); ?>
                                                                        </td>
                                                                        <td style="text-align: center">
                                                                            <?php
                                                                            if ($result->marks >= 70) {
                                                                                echo "A";
                                                                            } else if ($result->marks >= 60 && $result->marks <= 69) {
                                                                                echo "B";
                                                                            } else if ($result->marks >= 50 && $result->marks <= 59) {
                                                                                echo "C";
                                                                            } else if ($result->marks >= 45 && $result->marks <= 49) {
                                                                                echo "D";
                                                                            } else if ($result->marks >= 40 && $result->marks <= 44) {
                                                                                echo "E";
                                                                            } else if ($result->marks >= 0 && $result->marks <= 39) {
                                                                                echo "F";
                                                                            }
                                                                            ?>
                                                                        </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="5" align="center"><i class="fa fa-print fa-2x"
